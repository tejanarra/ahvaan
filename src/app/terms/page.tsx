    ...
    <div className="flex min-h-dvh flex-col">
      <div className="mx-auto w-full max-w-2xl flex-1 px-4 py-12 sm:px-6">
        ...
        <section>
          ...
          <p className="mt-2">
            ahvaan is free, with no paid plans or billing. We may add, change, or remove features
        ...
        <section>
          ...
          <p className="mt-2">
            ...
            ahvaan to collect information you don&rsquo;t have a right to collect, to send unwanted or
        ...
        <section>
          ...
          <p className="mt-2">
            We aim to keep ahvaan available and your data intact, but we can&rsquo;t guarantee
