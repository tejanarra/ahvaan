...
// A card with a folded corner and a swatch strip — represents the invitation
// page itself (design system's "swatch strip" signature motif), distinct
// from FormIcon's checklist look.
export function InvitePageIcon({ className = base }: IconProps) {
  return (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={2} className={className}>
      ...
      <path d="M8 18h5" strokeLinecap="round" />
    </svg>
  );
}
