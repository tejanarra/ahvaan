...
- **Left**: eyebrow caption ("Free forever · No guest accounts", small-caps
  ...
  signature move #1) Subline (≤ 2 lines): "Gatherie gives every event a
...
### 9. Footer
Wordmark, caption "© Gatherie", links: Sign in · Sign up. Nothing else in v1
...
- SEO: `generateMetadata` with title "Gatherie — Beautiful invitations with
