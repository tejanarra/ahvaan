...
A totally custom design language for Gatherie, replacing the current
...
Gatherie is two products wearing one brand:
...
- **Name/wordmark**: “gatherie” set in the display serif (see Typography),
...
### Signature style moves (what makes Gatherie look like *only* Gatherie)
